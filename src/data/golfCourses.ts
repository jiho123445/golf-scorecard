...
export const golfCourses: GolfCourse[] = [
  ...
  },
  {
    ...
    // 공식 홈페이지(hilldeloci.co.kr) 코스안내 페이지 기준, 사용자 확인 스크린샷으로 검증됨
    courseYardages: {
      'Birch': [358, 506, 402, 379, 150, 432, 219, 348, 620],
      'Pine': [374, 516, 368, 178, 544, 173, 357, 431, 432],
    },
  },
  {
  ...
  // 공식 홈페이지(sonofelicecc.com) 상단 내비게이션 및 코스제원 스크린샷으로 확인: 실제 운영 구조는
  // '비발디파크 EAST'(18홀)+'비발디파크 WEST'(18홀) = 36홀이며, 기존에 등록됐던 '마운틴·레이크·실크 27홀'과
  // 'EAST+WEST+마운틴 45홀' 가설은 모두 사실이 아닌 것으로 확인되어 폐기.
  // ⚠️ WEST 코스는 아직 코스제원(Par·거리) 스크린샷을 받지 못해 미반영 — 확인되면 추가 필요.
  {
    id: 'sonofelice-vivaldi', name: '소노펠리체 컨트리클럽', region: '강원특별자치도 홍천군', totalHoles: 36,
    courses: ['EAST OUT', 'EAST IN', 'WEST OUT', 'WEST IN'],
    aliases: ['소노펠리체', 'sonofelice', '비발디', '비발디파크', '비발디파크cc', '대명비발디파크', 'vivaldi', '비발디파크EAST', '비발디파크WEST'],
    coursePars: { 'EAST OUT': P([4,4,5,4,3,4,4,3,5]), 'EAST IN': P([4,5,3,5,4,4,4,3,4]) },
    courseYardages: {
      // 공식 홈페이지 코스제원 표(화이트티, m) 사용자 확인 스크린샷 기준
      'EAST OUT': [344, 366, 537, 314, 136, 324, 320, 119, 481],
      'EAST IN': [297, 500, 133, 460, 332, 398, 314, 145, 370],
    },
  },
  ...
  // 경기
  {
    ...
    courseYardages: {
      '동코스 OUT': [350, 462, 343, 157, 368, 361, 494, 158, 357],
      '동코스 IN': [360, 366, 177, 376, 467, 359, 175, 343, 475],
      '서코스 OUT': [483, 357, 133, 348, 361, 128, 344, 478, 299],
      '서코스 IN': [378, 516, 143, 345, 400, 501, 340, 167, 298],
      '남코스 OUT': [395, 342, 171, 364, 356, 505, 169, 370, 498],
      '남코스 IN': [370, 464, 180, 382, 444, 190, 383, 390, 344],
    },
  },
  {
    ...
    // 동코스만 거리 확인됨(제3자 후기 블로그, Par 완전 일치로 검증). 서코스는 소스를 찾지 못해 거리 미표시
    courseYardages: {
      '동코스 OUT': [370, 330, 480, 160, 385, 150, 320, 430, 330],
      '동코스 IN': [470, 320, 120, 330, 370, 320, 475, 135, 320],
    },
  },
  ...
  { id: 'hanwha-plaza-yongin', name: '플라자CC 용인', region: '경기도 용인시', totalHoles: 36 },
  {
    ...
    // 거리는 제3자 후기 블로그 기준(Par 완전 일치로 검증), 정확한 티 구분은 불확실
    courseYardages: {
      '챔피언코스 OUT': [320, 170, 480, 120, 360, 140, 480, 310, 430],
      '챔피언코스 IN': [420, 190, 400, 370, 480, 185, 430, 460, 350],
    },
  },
  {
    ...
    courseYardages: {
      '서코스': [495, 343, 152, 284, 321, 305, 133, 430, 378],
      '중코스': [334, 358, 149, 471, 306, 144, 327, 312, 458],
      '동코스': [406, 303, 155, 337, 528, 159, 313, 309, 318],
    },
  },
  {
    ...
    courseYardages: { '레이크코스': [360, 507, 342, 334, 198, 398, 568, 178, 350], '마운틴코스': [332, 382, 522, 371, 159, 535, 392, 215, 464] },
  },
  {
    ...
    courseYardages: {
      '이스트코스': [524, 402, 380, 167, 336, 414, 211, 368, 497],
      '노스코스': [535, 384, 174, 390, 490, 341, 218, 388, 389],
      '웨스트코스': [406, 377, 410, 226, 326, 566, 173, 384, 511],
    },
  },
  {
  ...
  },
  {
    ...
    courseYardages: { '스카이코스': [349, 474, 320, 168, 448, 303, 135, 374, 367], '밸리코스': [324, 492, 161, 352, 382, 338, 128, 452, 355] },
  },
  ...
  {
    // 공식 홈페이지(haesley.com) 코스제원(Members/White 티, m) 기준. 해슬리 9번(340m)·PGA 2번(462m)은
    // 제3자 사이트(GolfPass)와 수치가 달라 교차검증에서 완전히 일치하지 않았으나, 공식 출처 자체는 이 값으로
    // 확인되어 낮은 신뢰도로 표기하여 반영. 나머지 16개 홀은 독립 검증 기준과 정확히 일치.
    id: 'haesley', name: '해슬리 나인브릿지', region: '경기도 여주시', totalHoles: 18,
    courses: ['해슬리', 'PGA'],
    aliases: ['해슬리코스', 'PGA코스', '해슬리나인브릿지', 'haesley nine bridges'],
    coursePars: { '해슬리': P([4,3,5,4,5,3,4,4,4]), 'PGA': P([4,5,4,4,3,4,5,3,4]) },
    courseYardages: {
      '해슬리': [295, 140, 457, 310, 447, 165, 365, 425, 340],
      'PGA': [265, 462, 360, 310, 125, 317, 474, 180, 390],
    },
  },
  {
    ...
    courseYardages: { 'POINT': [315, 359, 151, 304, 445, 348, 154, 332, 533] },
  },
  {
    ...
    courseYardages: { '팜파스': [302, 513, 414, 152, 516, 366, 135, 309, 353], '밸리': [509, 318, 306, 331, 140, 281, 136, 324, 461] },
  },
  ...
  { id: 'ansung-benest', name: '안성베네스트 골프클럽', region: '경기도 안성시', totalHoles: 36, courses: ['북코스', '서코스', '남코스', '동코스'] },
  {
    ...
    courseYardages: { 'OUT': [358, 373, 174, 383, 500, 527, 149, 365, 370], 'IN': [385, 427, 173, 527, 358, 149, 577, 405, 397] },
  },
  { id: 'new-korea', name: '뉴코리아 컨트리클럽', region: '경기도 고양시', totalHoles: 18 },
  // 문화코스·예술코스(각 18홀) 2코스로 확인되었으나 홀별 Par 소스를 찾지 못해 기본값 유지
  {
    // 공식 홈페이지(newseoulgolf.co.kr) 화이트티 좌그린 기준 거리 확인됨(문화코스만). 예술코스는 홀별 거리
    // 확인 소스를 찾지 못해 Par/거리 미반영.
    id: 'new-seoul', name: '뉴서울 컨트리클럽', region: '경기도 광주시', totalHoles: 36,
    courses: ['문화코스 OUT', '문화코스 IN', '예술코스 OUT', '예술코스 IN'],
    aliases: ['뉴서울CC', '뉴서울', 'new seoul'],
    coursePars: { '문화코스 OUT': P([4,4,3,5,4,5,4,3,4]), '문화코스 IN': P([4,5,3,4,4,5,3,4,4]) },
    courseYardages: {
      '문화코스 OUT': [385, 361, 142, 480, 359, 427, 314, 155, 395],
      '문화코스 IN': [320, 464, 170, 357, 340, 501, 167, 315, 375],
    },
  },
  { id: 'namseoul', name: '남서울 컨트리클럽', region: '경기도 성남시', totalHoles: 18 },
  // 동/서/남코스 Par는 확인됐으나, 공식 홈페이지가 홀별 거리를 이미지로만 제공해(텍스트 추출 불가) 거리는 미표시
  {
  ...
  {
    // 거리는 공식 홈페이지의 홀별 페이지 '헤드라인' 수치를 사용했으나 화이트/레귤러인지 명확히 표기되어 있지 않아 중간 신뢰도
    ...
    courseYardages: {
      'GRIFFIN': [381, 524, 382, 410, 165, 530, 402, 168, 391],
      'PHOENIX': [361, 373, 222, 432, 485, 172, 392, 353, 470],
      'WYVERN': [436, 620, 210, 340, 505, 432, 178, 310, 350],
    },
  },
  {
    ...
    courseYardages: {
      '서코스': [383, 472, 192, 358, 344, 504, 182, 400, 358],
      '중코스': [360, 394, 180, 387, 470, 339, 348, 160, 518],
      '동코스': [400, 512, 151, 339, 371, 500, 383, 188, 408],
      'PUBLIC': [272, 263, 144, 395, 319, 96, 263, 462, 277],
    },
  },
  ...
  // 충청
  {
    ...
    courseYardages: { 'OUT': [357, 358, 393, 142, 482, 303, 173, 502, 392], 'IN': [397, 455, 297, 150, 374, 312, 175, 410, 509] },
  },
  ...
  {
    // 전/후반이 'SKY(계백장군)'·'HILL(의자왕)'이라는 실제 명칭으로 운영됨. 거리는 확인됐으나 화이트/레귤러 티 여부는 사이트에 명확히 표기되지 않아 중간 신뢰도
    ...
    courseYardages: { 'SKY(계백장군)': [330, 335, 314, 356, 159, 445, 302, 146, 436], 'HILL(의자왕)': [305, 325, 123, 446, 246, 132, 465, 280, 298] },
  },
  ...
  },
  {
    ...
    courseYardages: {
      '천마코스 OUT': [357, 462, 146, 302, 338, 485, 174, 320, 375],
      '천마코스 IN': [347, 475, 329, 192, 402, 311, 366, 123, 521],
      '화랑코스 OUT': [319, 352, 175, 521, 273, 140, 484, 370, 331],
      '화랑코스 IN': [383, 451, 345, 186, 543, 316, 124, 371, 360],
    },
  },
  ...
  },
  {
    ...
    courseYardages: {
      '로얄코스': [366, 477, 147, 322, 306, 510, 402, 332, 160],
      '실크코스': [332, 147, 331, 296, 372, 448, 370, 182, 498],
      '골든코스': [479, 173, 378, 451, 331, 378, 155, 333, 378],
    },
  },
  ...
  // 호남
  {
    ...
    courseYardages: {
      '동악코스': [365, 398, 509, 360, 162, 480, 336, 199, 345],
      '섬진코스': [371, 328, 185, 543, 396, 491, 314, 176, 375],
      '설산코스': [371, 395, 158, 490, 393, 154, 501, 330, 332],
    },
  },
  ...
  { id: 'eodeungsan', name: '어등산 컨트리클럽', region: '광주광역시', totalHoles: 27, courses: ['어등코스', '송정코스', '하남코스'] },
  {
    ...
    courseYardages: {
      'GOLD': [520, 330, 210, 400, 365, 505, 140, 340, 330],
      'LAKE': [420, 200, 490, 335, 372, 175, 380, 430, 515],
      'HILL': [400, 566, 407, 195, 353, 521, 168, 368, 352],
      'VALLEY': [364, 157, 377, 500, 346, 321, 361, 153, 492],
    },
  },
  {
    // 스프링·썸머·어텀 3코스 27홀
    ...
    courseYardages: {
      '스프링코스': [315, 432, 137, 338, 130, 335, 314, 339, 426],
      '썸머코스': [304, 336, 290, 120, 409, 301, 139, 380, 330],
      '어텀코스': [411, 282, 316, 294, 117, 249, 437, 117, 282],
    },
  },
  ...
  { id: 'dasan-beach', name: '다산베아채 골프앤리조트', region: '전라남도 강진군', totalHoles: 27, courses: ['다산코스', '베아채코스', '장보고코스'] },
  {
    ...
    courseYardages: { '마운틴코스': [288, 432, 333, 535, 167, 286, 155, 296, 293], '레이크코스': [348, 308, 331, 503, 176, 318, 338, 138, 450] },
  },
  ...
  { id: 'haevichi-jeju', name: '해비치 컨트리클럽 제주', region: '제주특별자치도 서귀포시', totalHoles: 36, courses: ['SKY', 'PALM', 'LAKE', 'VALLEY'] },
  {
    ...
    courseYardages: {
      'SKY': [367, 300, 313, 467, 109, 352, 257, 143, 422],
      'HILL': [441, 92, 333, 283, 117, 260, 355, 564, 342],
      'OCEAN': [354, 234, 323, 327, 134, 472, 333, 153, 490],
      'FOREST': [415, 264, 359, 95, 377, 452, 361, 131, 416],
    },
  },
